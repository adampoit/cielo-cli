...
{
    public static Task<int> RunForegroundAsync(MonitorCommandOptions options, CancellationToken cancellationToken)
    {
        ...
        CancellationToken cancellationToken)
    {
        try
        {
            ...
            using var client = new CieloClient(config, CieloConfigStore.ExpandPath(options.ConfigPath));
