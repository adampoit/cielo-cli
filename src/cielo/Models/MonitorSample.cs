...
{
	public decimal? TargetTempValue =>
		decimal.TryParse(TargetTemp, NumberStyles.Any, CultureInfo.InvariantCulture, out var value)
			? value
			: null;
	...
	public static MonitorSample FromDevice(
		CieloDevice device,
		DateTimeOffset timestamp,
		string source,
		OutdoorWeatherSnapshot? outdoorWeather = null
	)
	{
