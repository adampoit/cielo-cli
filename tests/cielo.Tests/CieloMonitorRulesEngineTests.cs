...
public sealed class CieloMonitorRulesEngineTests
{
    ...
    public async Task EvaluateAsync_DryRunFiresThenRearmsAfterRecovery()
    {
        ...
        try
        {
            await engine.EvaluateAsync(CreateSample(63m, DateTimeOffset.Parse("2026-04-10T15:00:00Z")));
            await engine.EvaluateAsync(CreateSample(63m, DateTimeOffset.Parse("2026-04-10T15:01:00Z")));
            await engine.EvaluateAsync(CreateSample(65m, DateTimeOffset.Parse("2026-04-10T15:02:00Z")));
            await engine.EvaluateAsync(CreateSample(63m, DateTimeOffset.Parse("2026-04-10T15:03:00Z")));
        }
        finally
        {
    ...
    public async Task EvaluateAsync_SkipsRulesOutsideActiveWindow()
    {
        ...
        try
        {
            await engine.EvaluateAsync(CreateSample(63m, DateTimeOffset.Parse("2026-04-10T03:00:00Z")));
        }
        finally
        {
            Console.SetError(originalError);
    ...
    public async Task EvaluateAsync_MatchesRulesInsideOvernightWindow()
    {
        ...
        try
        {
            await engine.EvaluateAsync(CreateSample(63m, DateTimeOffset.Parse("2026-04-10T23:30:00Z")));
        }
        finally
        {
            Console.SetError(originalError);
